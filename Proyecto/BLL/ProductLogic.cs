...
namespace BLL
{
    public class ProductLogic
    {
        ...
        public List<Products> GetAllProducts() // Método para obtener todos los productos
        {
            List<Products> result = null;
            using (var r = RepositoryFactory.CreateRepository())
            {
                result = r.GetAll<Products>().ToList(); // Asegúrate de que este método exista en tu repositorio
            }
            return result;
        }
